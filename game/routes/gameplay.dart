...
import 'package:ski_runner/game/actors/snowman.dart';
import 'package:ski_runner/game/game.dart';
import 'package:ski_runner/game/hud.dart';
import 'package:ski_runner/game/input.dart';
import 'package:ski_runner/game/actors/player.dart';

class Gameplay extends Component with HasGameReference<SkiRunnerGame> {
  Gameplay(
    this.currentLevel, {
    super.key,
  ...
  Future<void> onLoad() async {
    if (game.musicValueNotifier.value) {
      _bgmPlayer = await FlameAudio.loopLongAudio(SkiRunnerGame.bgm, volume: 0);
    }
    ...
    _hud = Hud(
      ...
      input: SkiRunnerGame.isMobile ? input : null,
      onPausePressed: SkiRunnerGame.isMobile ? onPausePressed : null,
    );
  ...
  Future<void> _setupWorldAndCamera(TiledComponent map) async {
    ...
    const height = SkiRunnerGame.isMobile ? 200.0 : 180.0;
    final width = SkiRunnerGame.isMobile ? height * aspectRatio : 320.0;
